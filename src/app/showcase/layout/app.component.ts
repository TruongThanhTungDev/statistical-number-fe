...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, FormsModule, ReactiveFormsModule, HttpClientModule, AppMainComponent, AppTopBarComponent, AppMenuComponent, InputTextModule, LoginModule, TabMenuModule],
  providers: [
    CarService,
    CountryService,
    EventService,
